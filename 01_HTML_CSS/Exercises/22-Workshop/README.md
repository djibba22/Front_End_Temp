...
* Note: The **Coming Soon box** is an image that is provided in the `assets/glint.jpg` directory. 

![The landing page contains a header, footer, a main section page with an image provided to display in the middle of the screen. Some text and a Contact Me form is also included.](./assets/example.png)
