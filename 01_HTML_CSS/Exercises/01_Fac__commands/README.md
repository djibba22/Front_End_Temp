#  Facilitators Showcase: Command Line
...
* Open your terminal and do the following:
  ...
  * 🔑 We use the `mkdir` command to create a new directory named `examples`.
 
  ```bash
  mkdir examples
  ```

  * 🔑 To add a file to our new directory, we first use `cd` to navigate into `examples`.
