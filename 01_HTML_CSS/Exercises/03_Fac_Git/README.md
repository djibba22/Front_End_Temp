#  Facilitator Demo: Git

* It is important to be able to store and manage code as well as share it with others. In this program, we will be using a tool called Github.

* Open [Github](https://github.com/) in your browser.

  * In this program, we will share code in repositories using Github.

  * Click on the `new` button to demonstrate how to create a new repository.

  * Select your profile from the “Owner” dropdown menu and give the new repository the name `split-stack-demo`.
